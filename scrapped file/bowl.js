...
const url="https://stats.espncricinfo.com/ci/engine/records/bowling/most_wickets_career.html?id=14452;type=tournament";
console.log("before");
...
function extractHtml(html){
    ...
    let comment={};
        ...
        jsonfile.writeFile('bowl.json',comment,{ flag: 'a'},function(err){
            if(err)
                console.log(err);
        } );
