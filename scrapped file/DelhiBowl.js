...
const url="https://stats.espncricinfo.com/ci/engine/records/bowling/most_wickets_career.html?id=14452;team=4344;type=tournament";
console.log("before");
...
function extractHtml(html){
    ...
    jsonfile.writeFile('DCbowl.json',"");
    ...
    let avg=$(tmatchs[8]);
        ...
        jsonfile.writeFile('DCbowl.json',comment,{ flag: 'a'},function(err){
            if(err)
                console.log(err);
        } );
