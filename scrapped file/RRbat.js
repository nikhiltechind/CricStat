...
const url="https://stats.espncricinfo.com/ci/engine/records/batting/most_runs_career.html?id=14452;team=4345;type=tournament";
console.log("before");
...
function extractHtml(html){
    ...
    let comment={};
        ...
        jsonfile.writeFile('RRbat.json',comment,{ flag: 'a'},function(err){
            if(err)
                console.log(err);
        } );
