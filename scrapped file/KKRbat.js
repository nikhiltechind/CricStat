...
const url="https://stats.espncricinfo.com/ci/engine/records/batting/most_runs_career.html?id=14452;team=4341;type=tournament";
console.log("before");
...
function extractHtml(html){
    ...
    let note=$(".note");
    jsonfile.writeFile('KKRbat.json',"");
    ...
    let comment={};
        ...
        jsonfile.writeFile('KKRbat.json',comment,{ flag: 'a'},function(err){
            if(err)
                console.log(err);
        } );
