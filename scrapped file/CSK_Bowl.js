...
const url="https://stats.espncricinfo.com/ci/engine/records/bowling/most_wickets_career.html?id=14452;team=4343;type=tournament";
console.log("before");
...
function extractHtml(html){
    ...
    jsonfile.writeFile('CSKbowl.json',"");
    ...
    let comment={};
        ...
        jsonfile.writeFile('CSKbowl.json',comment,{ flag: 'a'},function(err){
            if(err)
                console.log(err);
        } );
