...
const url="https://stats.espncricinfo.com/ci/engine/records/batting/most_runs_career.html?id=14452;team=4344;type=tournament";
console.log("before");
...
function extractHtml(html){
    ...
    jsonfile.writeFile('DCbat.json',comment,{ flag: 'a'},function(err){
        if(err)
            console.log(err);
    } );
