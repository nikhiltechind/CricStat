...
const url="https://stats.espncricinfo.com/ci/engine/records/bowling/most_wickets_career.html?id=14452;team=4342;type=tournament";
console.log("before");
...
function extractHtml(html){
    ...
    let note=$(".note");
    jsonfile.writeFile('PKBSbowl.json',"");
    ...
    let comment={};
        ...
        jsonfile.writeFile('PKBSbowl.json',comment,{ flag: 'a'},function(err){
            if(err)
                console.log(err);
        } );
